      ...
      <g fill={color}>
        ...
        >
          <g>
            <g>
              <path
                className="fill-[#fbd2b0] dark:fill-logo-dark-st0"
                d="M785.96,386.66c-35.65,42.28-90.59-11.81-48-44.47c21.02-13.92,69.9-97.48,99.49-72.69
			C900,321.88,806.85,365.16,785.96,386.66z"
              />
              <path
                className="fill-[#fcedd5] dark:fill-logo-dark-st1"
                d="M689.97,188.43c-17.81,29.8-36.66,73.04-49.87,105.48c-14.58,20.74,31.44,46.51,45.64,30.8
			c7.33-12.49,30.73-39.35,38.22-52.11C732.13,257.33,782,197.69,689.97,188.43z"
              />
              <path
                className="fill-[#fcedd5] dark:fill-logo-dark-st1"
                d="M677.41,191.46c-8.99,25.48-28.31,72.03-37.31,97.32c-5.25,34.77-62.04,13.35-84.94,11.29
			c55.03-47.11,63.94-94.64,14.37-146.69C596.01,158.71,698.02,149.2,677.41,191.46z"
              />
              <path
                className="fill-[#b7d9fd] dark:fill-logo-dark-st2"
                d="M209.43,322.9c20.33-11.83,51.54,30.24,61.87,40.15c30.84,30.8,0.59-6.45,21.22,34.73
			c29.02,20.12,27.37,51.22-13.52,49.74c-17.45-7.58-33.66-16.61-51.42-23.24C175.03,404.63,171.2,369.38,209.43,322.9z"
              />
              <path
                className="fill-[#c0f6f1] dark:fill-logo-dark-st3"
                d="M395.19,331.33c-16.26,68.75-99.4-16.56-124.86-56.22c-15.12-23.56,25.19-39.14,38.87-44.29
			C343.29,217.99,344.36,269.73,395.19,331.33z"
              />
              <path
                className="fill-[#c4abef] dark:fill-logo-dark-st4"
                d="M287.92,470.33"
              />
              <path
                className="fill-[#c4abef] dark:fill-logo-dark-st4"
                d="M124.95,510.92c0.4,0.55,58.78-106.42,59.01-107.06c2.52-6.75-51.76,19.17-46.62,15.7
			...
			c112.03-33.31,137.79,64.94,138.5,64.69"
              ...
              <path
                className="fill-[#c4abef] dark:fill-logo-dark-st4"
                d="M272.01,490c-2.12,1.37-1.83-1.24-3.8-0.12c-0.13,0.07-0.28,0.12-0.43,0.12
			c-29.33-0.01-67.61,6.65-96.46,3.17c-0.62-0.07-0.94-0.77-0.62-1.3l3.51-5.75c0.17-0.28,0.17-0.63-0.02-0.91"
              />
              <path
                className="fill-[#ccfdde] dark:fill-logo-dark-st5"
                d="M395.19,188.43c-7.85-19.11,28.33-25.93,40.79-28.75c128.52-43.4-28.85,63.95,86.21,127.48
			c-17.14,4.56-72.23,37.88-79.45,12.9C430.48,265.87,394.91,220.88,395.19,188.43z"
              />
              <path
                className="fill-[#ccfdde] dark:fill-logo-dark-st5"
                d="M346.93,246.15c-4.49-8.85-34.91-34.61-21.24-42.25c13.9-7.45,52.66-18.22,72.68-8.3
			c9.44,30.53,73.31,158.39-7.94,123.03C375.93,294.47,361.43,270.31,346.93,246.15z"
              />
              <path
                className="fill-[#fcedd5] dark:fill-logo-dark-st1"
                d="M658.37,319.04c-0.01-0.01-0.02-0.01-0.03-0.02c0,0,0,0-0.01,0C658.33,319.02,658.37,319.04,658.37,319.04z"
              />
              <path
                className="fill-[#c0f6f1] dark:fill-logo-dark-st3"
                d="M295.8,307.58c-21.7-26.24-50.37-53.18-73.81-0.57c-13.37,30.01,73.86,98.43,115.19,90.7
			C380.09,389.69,321.37,324.55,295.8,307.58z"
              />
              <path
                className="fill-[#fcedd5] dark:fill-logo-dark-st1"
                d="M578.47,159.6c-0.13-0.16-0.27-0.31-0.4-0.47c0.1,0.18,0.2,0.36,0.29,0.54
			C578.36,159.67,578.47,159.6,578.47,159.6z"
              />
              <path
                className="fill-[#fbd2b0] dark:fill-logo-dark-st0"
                d="M814.42,261.57c-16.53,37.88-57.98,66.09-85.57,98.04c-72.37,6.08-3.4-85.98,8.8-110.3
			c25.1-50.02,51.18,4.09,63.37-1.27C803.95,246.75,811.62,261.06,814.42,261.57z"
              />
              <path
                className="fill-[#c4abef] dark:fill-logo-dark-st4"
                d="M861.12,494c-49.26,11.49-92.99-14.14-39.72-53.38c62.39-45.96,99.68-44.63,97.2,21.26
			C927.1,498.43,882.22,493.53,861.12,494z"
              />
              <path
                className="fill-[#f7bfa5] dark:fill-logo-dark-st6"
                d="M763.5,417.43c11.36-31.1,69.88-66.86,97.2-83.89c15.22,11.7,52.97,59.97,25.51,68.62
          ...
          <g>
            <path
              className="fill-[#111033] dark:fill-[#e9eeff]"
              d="M948.09,563.68c-37.06-0.28-74.13-0.77-111.19-0.7c-11.01,0.02-21.59-0.29-24.55-13.25
		...
		C906.11,642.91,893.48,648.13,878.75,646.8z"
            ...
            <path
              className="fill-[#111033] dark:fill-[#e9eeff]"
              d="M387.86,197.62C387.65,197.63,387.69,197.63,387.86,197.62L387.86,197.62z"
            />
            <polygon
              className="fill-[#111033] dark:fill-[#e9eeff]"
              points="658.35,319.04 658.35,319.04 658.35,319.04 	"
            />
            <path
              className="fill-[#111033] dark:fill-[#e9eeff]"
              d="M172.19,434.99c-0.01,0.05-0.02,0.09-0.04,0.14c0.35-0.74,0.71-1.47,1.04-2.21
		C172.86,433.6,172.53,434.29,172.19,434.99z"
            />
            <path
              className="fill-[#111033] dark:fill-[#e9eeff]"
              d="M388.11,197.6c-0.09,0.01-0.18,0.01-0.24,0.01C387.92,197.61,388,197.61,388.11,197.6z"
            />
            <path
              className="fill-[#111033] dark:fill-[#e9eeff]"
              d="M388.35,197.59c-0.1,0.01-0.17,0.01-0.24,0.01C388.18,197.6,388.27,197.59,388.35,197.59z"
            />
          </g>
        </svg>
      </g>
  ...
  const menu = {
    ...
    if (!isLoaded) {
  	...
  	return <nav className="sticky top-0 bg-gradient-to-bl 
        ...
        <small className="px-8 w-full flex justify-center">{subHeader}</small>
     </nav>
  }
