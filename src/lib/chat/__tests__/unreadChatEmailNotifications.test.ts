...
test('unread chat email template uses Dupip palette and omits message contents', () => {
  ...
  assert.match(html, /https:\/\/www\.dupip\.com\/images\/logo\.png/)
  assert.match(html, /Dupip logo/)
  assert.match(html, /@alice/)
  assert.match(html, /Bob Example/)
  assert.match(html, /© 2012-2026 Dupip\. All rights reserved\./)
  assert.match(html, /IVA IT02925300903/)
  assert.match(html, /REA 572763/)
  assert.match(html, /CNPJ 37\.553\.462\/0001-46/)
