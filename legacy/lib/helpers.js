...
export const ALTERNATE = (path) => [
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + path.substring(1),
    hreflang: 'x-default',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'en' + path,
    hreflang: 'en',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'it-it' + path,
    hreflang: 'it-it',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'pt-br' + path,
    hreflang: 'pt-br',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'es-es' + path,
    hreflang: 'es-es',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'de-de' + path,
    hreflang: 'de-de',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'fr-fr' + path,
    hreflang: 'fr-fr',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'es-es' + path,
  ...
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'ro' + path,
    hreflang: 'ro',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'pl-pl' + path,
    hreflang: 'pl-pl',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'cs-cz' + path,
    hreflang: 'cs-cz',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'sv-se' + path,
    hreflang: 'sv-se',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'et-ee' + path,
    hreflang: 'et-ee',
  },
  {
    href: (process.env.SITE_URL || "https://www.dupip.com/") + 'ja-jp' + path,
    hreflang: 'ja-jp',
  },
]
...
export const generateApiCall = (path) => {
  if (process.env.NEXT_PUBLIC_DEV) {
    ...
    return `https://beta.dupip.com` + path
  }
  return 'https://www.dupip.com' + path
}
