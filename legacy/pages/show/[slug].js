  ...
  return (
    <>
      <Head>
        ...
        <meta property="og:description" content={`${localization['country']}: ${country}, ${localization['artist']}: ${artists}` || "Upstreaming. 📡"} />
        <meta name="description" content={`${localization['country']}: ${country}, ${localization['artist']}: ${artists}` || "Upstreaming. 📡"} />
        <meta property="og:type" content="website" />
        <meta
          property="og:image"
          content={(show?.image?.url || "https://www.dupip.com/og-image.png") + "?fm=jpg&w=800&h=418&fit=fill"}
        />
        <meta
          property="twitter:image"
          content={(show?.image?.url || "https://www.dupip.com/og-image.png") + "?fm=jpg&w=800&h=418&fit=fill"}
        //content={(show?.image?.url || "https://www.dupip.com/og-image.png") + "?fm=filljpg&w=512"}
        />
        <meta
          property="og:image:secure_url"
          content={(show?.image?.url || "https://www.dupip.com/og-image.png") + "?fm=jpg&w=800&h=418&fit=fill"}
        //content={(show?.image?.url || "https://www.dupip.com/og-image.png")}
        />
        <meta property="og:image:type" content="image/jpeg" />
        <meta property="og:image:width" content="800" />
        <meta property="og:image:height" content="418" />
        <link rel="canonical" href={url} />
        <link rel="alternate" hrefLang="x-default" href={`https://www.dupip.com/show/${show?.url}`} />
        {Object.keys(localeMap).map((locale) => {
          return <link key={locale} rel="alternate" hrefLang={locale} href={`https://www.dupip.com/${locale}/show/${show?.url}`} />
        })}
      </Head>
...
const CountdownComponent = ({ mobileApp, countStart, localization, event, locale, url }) => {
  ...
  const handleIcs = async () => {
    ...
    const eventData = {
      ...
      title: event?.title + ' at Dupip',
      url: url || 'https://www.dupip.com',
      location: undefined,
      locale,
