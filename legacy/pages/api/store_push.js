...
export default async function (req, res) {
  try {
    ...
    const endpoint = `https://eu-west-1.aws.data.mongodb-api.com/app/application-0-pdnug/endpoint/add_push?secret=${process.env.CLOUD_SECRET}&project=${project}&data=${encodeURIComponent(token)}&locale=${locale}`;
    ...
    const headers = {
      ...
      //'Access-Control-Allow-Origin': 'https://www.dupip.com',
